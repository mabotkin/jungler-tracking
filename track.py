...
graph[2][1]["weight"] = 0.35 #wolves to blue
graph[2][19]["weight"] = 0.35 #wolves to mid
...
graph[7][10]["weight"] = 0.8 #baron to scuttle
graph[7][15]["weight"] = 0.1 #baron to enemy red
graph[7][21]["weight"] = 0.1 #baron to base

graph[8][9]["weight"] = 0.8 #dragon to scuttle
...
graph[9][3]["weight"] = 0.1 #bot scuttle to wraiths
...
graph[10][8]["weight"] = 0.1 #top scuttle to blue
...
graph[13][12]["weight"] = 0.35 #wolves to blue
graph[13][19]["weight"] = 0.35 #wolves to mid
